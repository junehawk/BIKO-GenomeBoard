...
description: "BIKO GenomeBoard의 변이 분류, tiering, 임상적 의사결정에 대한 가이드라인 기반 검증 절차. ACMG/AMP 2015, AMP/ASCO/CAP 2017, ACMG CNV 2020 가이드라인 요약과 검증 체크리스트. '임상 검토', '가이드라인', 'ACMG', 'AMP', 'tiering', '분류 로직', 'clinical review', '임상적 의미', '임상 자문' 관련 작업 시 사용."
---

# Clinical Validation — 임상 검증 절차

BIKO GenomeBoard의 모든 변이 분류와 tiering이 국제 가이드라인에 부합하는지 검증하는 절차.
