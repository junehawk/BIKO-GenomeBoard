...
*⁰ ClinGen SVI 2018은 PP5/BP6 사용을 **deprecated** 권고합니다 (PS1/PM5/population/function/segregation evidence와의 **double-counting** 위험 때문). BIKO는 현재 annotation + scoring 모두에 사용 중이며, §1.4의 A4 좁은 override gate와 정합성을 위해 유지하고 있습니다. **v2.5.3 별도 티켓에서 scoring evidence 제외 검토 예정** (annotation은 유지).*
